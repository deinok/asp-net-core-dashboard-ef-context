...
namespace VMES.Database.Vmes.Migrations
{
    ...
    [Migration("20231218122431_OrdenesTransicionesEstadosHistory_InicioValidez_DEFAULT")]
    partial class OrdenesTransicionesEstadosHistory_InicioValidez_DEFAULT
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VMES.Database.Vmes.Models.Dashboard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("VMES.Database.Vmes.Models.EntradasLineas", b =>
                {
                    ...
                    b.Property<string>("ReferenciaErp")
                        .HasColumnType("nvarchar(32)")
                        .HasMaxLength(32);
            ...
            modelBuilder.Entity("VMES.Database.Vmes.Models.HumanMachineInterfaceBascula", b =>
                {
                    b.Property<int>("HumanMachineInterfaceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("HumanMachineInterfaceId", "BasculaId");

                    b.HasIndex("BasculaId");

                    b.ToTable("HumanMachineInterfaceBasculas");
                });

            modelBuilder.Entity("VMES.Database.Vmes.Models.HumanMachineInterfaceTag", b =>
                {
                    b.Property<int>("HumanMachineInterfaceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("HumanMachineInterfaceId", "TagId");

                    b.HasIndex("TagId");

                    b.ToTable("HumanMachineInterfaceTags");
                });
            ...
            modelBuilder.Entity("VMES.Database.Vmes.Models.HumanMachineInterfaceBascula", b =>
                {
                    b.HasOne("VMES.Database.Vmes.Models.Bascula", "Bascula")
                        .WithMany("HumanMachineInterfaceBasculas")
                        .HasForeignKey("BasculaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VMES.Database.Vmes.Models.HumanMachineInterface", "HumanMachineInterface")
                        .WithMany("HumanMachineInterfaceBasculas")
                        .HasForeignKey("HumanMachineInterfaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("VMES.Database.Vmes.Models.HumanMachineInterfaceTag", b =>
                {
                    b.HasOne("VMES.Database.Vmes.Models.HumanMachineInterface", "HumanMachineInterface")
                        .WithMany("HumanMachineInterfaceTags")
                        .HasForeignKey("HumanMachineInterfaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VMES.Database.Vmes.Models.ProductoEnvaseEtiqueta", b =>
                {
                    b.HasOne("VMES.Database.Vmes.Models.Envases", "Envase")
